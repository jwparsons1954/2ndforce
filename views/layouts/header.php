...
<div class="wrap">
    ...
    echo Nav::widget([
        ...
        'items' => [
			...
			['label' => 'Profile', 'url' => ['/site/test'], 'linkOptions' => ['style' => 'color: #ffd700;'],'visible' => !Yii::$app->user->isGuest],
			['label' => 'Admin', 'url' => ['/admin/index'], 'linkOptions' => ['style' => 'color: #ffd700;'],'visible' => !Yii::$app->user->isGuest ],
